...
export const instrumentFixtures: readonly InstrumentFixture[] = [
  ...
  { instrument: { id: 'il-amot', symbol: 'אמות', name: 'אמות השקעות', market: 'IL', type: 'stock', priceUnit: 'ILA', priceDecimals: 0 }, previousClose: 6576, initialVolume: 151520, openingChangePercent: -2.03 },
